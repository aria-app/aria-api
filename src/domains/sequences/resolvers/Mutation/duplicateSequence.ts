...
type DuplicateSequenceResolver = (
  parent: Record<string, never>,
  args: {
    id: number;
  },
  context: ApiContext,
) => Promise<DuplicateSequenceResponse>;

export default <DuplicateSequenceResolver>(
  async function duplicateSequence(_, { id }, { currentUser, prisma }) {
    if (!currentUser) {
